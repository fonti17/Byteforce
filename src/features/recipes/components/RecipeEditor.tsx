...
import { RECIPE_COURSES, RECIPE_DIETS } from '../types';
import type { Recipe, RecipeCourse, RecipeDiet } from '../types';
...
/**
 * Form over one recipe, in the shape of `recipe.config.json`. Units are
