...
import type { GatheringData, GatheringUncertainty } from '../gathering';
import { QUESTION_ORDER, formatAnswer, questionLabel, type QuestionId } from '../../../shared/utils/fields';
