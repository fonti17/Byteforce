        ...
        <>
          ...
          <section className="flex flex-col gap-2">
            ...
            <Card className="flex flex-col gap-3 p-5 bg-white border border-neutral-200 rounded-lg shadow-xs">
              ...
              {plan.budget.note ? (
                <Typography.Paragraph className="text-sm text-neutral-600 mt-1">
                  {plan.budget.note}
                </Typography.Paragraph>
              ) : null}
            </Card>
          ...
          {plan.reasoning ? (
            <section className="flex flex-col gap-2">
              ...
              <Card className="p-4 bg-white border border-neutral-200 rounded-lg shadow-xs">
                <Typography.Paragraph className="whitespace-pre-line text-sm text-neutral-700 leading-relaxed">
                  {plan.reasoning}
                </Typography.Paragraph>
              </Card>
            </section>
