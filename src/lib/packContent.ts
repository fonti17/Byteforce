...
export function dimensionOf(unit: string): Dimension | null {
  return unitInfo(unit)?.dimension ?? null;
}
 ...
 */
export function contentFromTitle(title: string): TitleContent[] {
 ...
 */
export function unitsPerSalesUnit(product: TransgourmetProduct): number {
