...
import { purchaseOutcome, salesUnitContent } from '../lib/packContent.ts';
import type { ShoppingListEntry, WasteRisk } from '../types/cateringPlan.ts';
import type { TransgourmetProduct } from '../types/transgourmet.ts';
 ...
 * calculation.
 *
 * `schema` is `config/productChoiceConfig.json`.
 */
...
/** Reads the answer into `config/productChoiceConfig.json` shape. */
