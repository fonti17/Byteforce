import productChoiceConfig from '../../config/productChoiceConfig.json';
...
import { findCandidates } from './transgourmetCatalog';
import { purchaseOutcome, salesUnitContent } from '../lib/packContent';
import type {
  CateringPlan,
  PricedCateringPlan,
...
import type { LLMRequestOptions } from '../types/llm';
import type { TransgourmetProduct } from '../types/transgourmet';
