import cateringPlanConfig from './cateringPlan.config.json';
import { extractJsonObject } from '@/shared/utils/json';
import { llmService } from '@/shared/llm/llmService';
import { mergeRecipesIntoPlan, recipeContribution } from '@/features/recipes/recipeService';
import type {
  CateringMenuItem,
  CateringPlan,
  CateringPlanOptions,
...
import type { GatheringData, GatheringResult } from '@/features/gathering/types';
...
/**
 * Reads the part-2 answer into the shape of `cateringPlan.config.json`.
